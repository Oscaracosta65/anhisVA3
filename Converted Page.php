 ...
 * Joomla 5.x · PHP 8.1+
 *
 * GAME : Virginia Bank a Million (VA3)
 *   game_id    = VA3
 *   main balls = 6   (columns first–sixth)   range 01–40
 *   Extra Shot = 1   (column seventh)         range 01–40
 *
 * UPSTREAM VARS EXPECTED: $stateName, $stateAbrev, $gName, $dbCol
 */
...
if (isset($stateName, $gName) && $stateName !== '' && $gName !== '') {
    ...
    $doc->setMetaData('description', $stateName . ' ' . $gName . ' draw history, frequency analysis, hot and cold numbers, recency data, and SKAI advanced tools. LottoExpert.net analytical lottery intelligence.');
}
...
/**
 * --------------------------------------------------------------------------
 * Game-format constants
 * VA3 = Pick 6 main balls (01-40) + Extra Shot bonus (01-40, column seventh)
 * --------------------------------------------------------------------------
 */
$mainBallCount = 6;
$mainMin       = 1;
$mainMax       = 40;
$bonusLabel    = 'Extra Shot';
$bonusMin      = 1;
$bonusMax      = 40;
$bonusColumn   = 'seventh';
$mainColumns   = ['first', 'second', 'third', 'fourth', 'fifth', 'sixth'];
...
$rowsStar = ($nodCurrentStar === $nodCurrentMain)
    ? $rowsMain
    : leFetchRecentDraws($db, (string) $dbCol, $gameId, $nodCurrentStar);

[$mainCounts, $mainLastSeenIndex] = leInitRange(1, 40);
[$starCounts, $starLastSeenIndex] = leInitRange(1, 40);
...
$starChartLabels = leBuildNaturalLabels(1, 40);
$starChartValues = [];
 ...
 * --------------------------------------------------------------------------
 */
$pageTitle  = isset($stateName, $gName) ? ($stateName . ' ' . $gName . ' Results Analysis') : 'Lottery Results Analysis';
$pageDesc   = isset($stateName, $gName) ? ($stateName . ' ' . $gName . ' draw frequency, recency, and historical number analysis. LottoExpert.net.') : 'Lottery draw frequency and recency analysis.';
...
$jsonLdDataset = json_encode([
    '@context'    => 'https://schema.org',
    '@type'       => 'Dataset',
    'name'        => isset($gName) ? ($gName . ' Draw Frequency Dataset') : 'Lottery Draw Frequency Dataset',
    'description' => 'Historical draw frequency, recency, and distribution data for ' . (isset($gName) ? $gName : 'this lottery game') . '. Updated after each official drawing.',
    'url'         => $canonicalNoQuery,
], JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_HEX_TAG);
?>
<script type="application/ld+json"><?php echo $jsonLdPage; ?></script>
<script type="application/ld+json"><?php echo $jsonLdDataset; ?></script>
<style>
:root{
  --skai-blue:#1C66FF;
  --deep-navy:#0A1A33;
      ...
      <div class="skai-hero-top">
        ...
        <div class="skai-hero-copy">
          ...
          <div class="skai-ball-row" aria-label="Latest drawn numbers">
            ...
            <span class="skai-ball skai-ball--bonus"><?php echo htmlspecialchars(lePad2($es), ENT_QUOTES, 'UTF-8'); ?></span>
          </div>

          <div class="skai-hero-actions" aria-label="Primary actions">
            <a class="skai-btn skai-btn--primary" href="/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=VA3">
              Open SKAI Analysis
            </a>
            <a class="skai-btn skai-btn--secondary" href="/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=VA3">
              AI Predictions
            </a>
          ...
          <div class="skai-advanced-links" aria-label="Advanced tools">
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/skip-and-hit-analysis?game_id=VA3">Skip &amp; Hit Analysis</a>
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/markov-chain-monte-carlo-mcmc-analysis?game_id=VA3">MCMC Markov Analysis</a>
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/virginia-bank-a-million-heatmap-analysis">Heatmap Analysis</a>
          </div>
        </div>
  ...
  <section id="frequency-deep-dive" class="skai-section" aria-labelledby="frequency-title">
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Move from summary to full reference. The first panel below shows the complete main-number distribution across all values 01&ndash;40. The second panel shows the complete Extra Shot distribution for the selected extra shot window.
        </p>
      </div>
    </div>
        ...
        <div class="skai-grid">
          <div class="skai-card">
            <div class="skai-card-head skai-card-head--radiant">
              ...
              <span class="skai-card-sub">All values 01&ndash;40 across the last <?php echo (int) $nodCurrentStar; ?> drawings</span>
            </div>
            <div class="skai-card-body">
              <div class="skai-chart-shell">
                <div class="skai-chart-frame skai-chart-frame--medium">
                  <canvas id="starChart" aria-label="Extra Shot distribution chart" role="img"></canvas>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="skai-section-body">
      <div class="skai-two-col">
        ...
        <div class="skai-card">
          ...
          <div class="skai-table-wrap">
            <table id="skai-star-table" class="skai-table" aria-label="Extra Shot frequency table">
              <thead>
                <tr>
                  <th>Number</th>
                  <th>Drawn Times</th>
      ...
      <div class="skai-tool-grid">
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=VA3">Open SKAI Analysis</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=VA3">Open AI Predictions</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/skip-and-hit-analysis?game_id=VA3">Open Skip &amp; Hit</a>
          </div>
        </article>
      </div>

      <div class="skai-utility-grid">
        <a class="skai-utility-link" href="/picking-winning-numbers/artificial-intelligence/markov-chain-monte-carlo-mcmc-analysis?game_id=VA3">MCMC Markov Analysis</a>
        <a class="skai-utility-link" href="/picking-winning-numbers/artificial-intelligence/virginia-bank-a-million-heatmap-analysis">Heatmap Analysis</a>
  ...
  <section class="skai-section" aria-labelledby="method-title">
    ...
    <div class="skai-section-body">
      <div class="skai-method-note">
        <strong>Interpretation guidance:</strong> Frequency, recency, and spacing can provide useful context for reviewing draw history, but they should be treated as descriptive signals rather than guarantees. The purpose of this page is to make the recent behavior of the game easier to understand, compare, and carry into deeper SKAI analysis. Virginia Bank a Million is a Pick 6 game with an Extra Shot number. Main ball and Extra Shot analytics are kept separate throughout this page to ensure accurate representation of each pool.
      </div>
    </div>
  </section>
...
(function () {
  ...
  function renderCharts() {
    ...
    if (quietCanvas && chartData.quietLabels && chartData.quietLabels.length) {
      chartInstances['quietChart'] = new Chart(quietCanvas.getContext('2d'), {
        type: 'bar',
        data: {
    ...
    if (fullMainCanvas && chartData.mainLabels && chartData.mainLabels.length) {
      chartInstances['fullMainChart'] = new Chart(fullMainCanvas.getContext('2d'), {
        type: 'bar',
        data: {
    ...
    if (starCanvas && chartData.starLabels && chartData.starLabels.length) {
      chartInstances['starChart'] = new Chart(starCanvas.getContext('2d'), {
        type: 'bar',
        data: {
    ...
    if (recencyCanvas && chartData.mainLabels && chartData.mainLabels.length) {
      chartInstances['recencyChart'] = new Chart(recencyCanvas.getContext('2d'), {
        type: 'bar',
        data: {
          labels: chartData.mainLabels,
          datasets: [{
  ...
  function bindTrackers() {
    ...
    function bindGroup(selector, wrap, chipClass, emptyText) {
      ...
      for (i = 0; i < inputs.length; i++) {
        (function (sel, w, cc, et) {
          inputs[i].addEventListener('change', function () {
            renderTracked(sel, w, cc, et);
          });
